...
//        // Lecture 삽입
//        LectureJpaEntity lecture1 = LectureJpaEntity.toEntity(null, "자바 기초", "자바 기초에대해서 배운다", "홍길동", 10L, 30L, LocalDateTime.now().plusDays(1).withNano(0));
//        LectureJpaEntity lecture2 = LectureJpaEntity.toEntity(null, "스프링부트", "스프링부트 심화 과정", "링링링", 25L, 30L, LocalDateTime.now().plusDays(2).withNano(0));
//
